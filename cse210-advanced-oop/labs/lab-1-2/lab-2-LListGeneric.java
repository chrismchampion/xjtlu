 ...
 */
public class LListGeneric<A> {

    private BiNode<BandCard> listStart; // always pointing to the start of the list
    ...
    public class BiNode<B> {

        private B value;
        private BiNode<B> prev;
        private BiNode<B> tail;
