...
public class BandCard {
	// ----- constants ------------------------------------------------------
	static final int MAXIMUM_VOLUME = 11;
	
	// static volume class variable for all band cards initialized to 0
	static int greatestVolume = 0;
	 ...
	 */
	public BandCard(String name, int volume, int attitude, int cool, int eclecticism, int hair) {
		this.name = name;
		this.volume = volume;
	...
	/**
	 * For testing: see <a href="BandCardTest.maude">"BandCardTest.maude</a> for
	 * expected results.
	 *
	 * @param args not used
	 */
